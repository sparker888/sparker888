      ...
      <div className="max-w-2xl">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="inline-flex justify-center rounded-md bg-sky-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 dark:bg-amber-600 dark:hover:bg-amber-500 dark:focus-visible:outline-amber-600 transition-colors"
            >
              Send Message
            </button>
          </div>
