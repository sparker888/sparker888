  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/portal/documentation">
              <Button className="bg-white text-stone-900 hover:bg-gray-100 font-semibold">
                📚 View Documentation
              </Button>
            </Link>
            <Link href="/portal/dashboard">
              <Button variant="secondary" className="bg-stone-700 text-white border-stone-600 hover:bg-stone-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          {/* Documentation */}
          <div className="bg-stone-800 border border-stone-700 rounded-xl p-6 hover:border-stone-600 transition-colors">
            ...
            <Link href="/portal/documentation">
              <Button variant="secondary" className="w-full bg-stone-700 text-white border-stone-600 hover:bg-stone-600">
                Browse Docs →
              </Button>
            </Link>
          </div>
        ...
        <div className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 border border-purple-800/50 rounded-xl p-8 mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-stone-300">Next.js + PocketBase</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                <span className="text-2xl">📱</span>
              ...
              <p className="text-sm text-stone-300">Twitter, LinkedIn, Instagram+</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                <span className="text-2xl">💰</span>
              ...
              <p className="text-sm text-stone-300">Stripe Integration</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                <span className="text-2xl">📊</span>
              ...
              <p className="text-sm text-stone-300">Performance Tracking</p>
            </div>
          </div>
        </div>
