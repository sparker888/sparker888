...
I'm thrilled to announce our latest **Midjourney Prompt Manager** update! Since Midjourney v7 alpha launched late last week, I've conducted in-depth **research** and **A/B testing** with ChatGPt o1 pro to see how different prompt structures (short keyword lists vs. flowing descriptive sentences) impact results in **Midjourney v7**. Below, I’ll share my findings, outline my **new strategy** for Midjourney v7 prompt generation, and show you examples from four different tests.
...
I tested each approach against **Midjourney v7** (and sometimes v6.1) using the exact same parameters like `--stylize` and `--chaos` (note that v7 doesn't allow `--weird` EDIT: Chaos is now supported). My primary goals were **realism**, **visual consistency**, **clarity of style** and an overall final pleasing image.
...
<h3>3. Choose your Midjourney Prompt Manager Style Selections</h3>
<ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
...
Follow this workflow starting with this or your own base prompt, select the Midjourney Parameters, and go through the Midjourney Prompt Manager Style Categories and choose the keywords you want to guide the overall look of your image. 1, 2, and 3. Then copy the Key Prompt and input it into Midjourney for rendering.  That's it!
