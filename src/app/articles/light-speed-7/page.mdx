...
- **Dropdown Filter (Projects):** Filtered results for active, completed, paused, and archived projects
- **Dropdown Filter (Gallery):** Filtered results for most recent, top rated and most popular
