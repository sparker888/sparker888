...
**Tailwind CSS version 4**—bundled with Astro 5 by default, featuring updated utilities and color palettes, perfect for modern styling and clean, maintainable code bases.
