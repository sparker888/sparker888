...
export const article = {
  ...
  date: '2025-01-27',
  title: 'January Updates: Nav Bar, Themes, Moods, and Visual Enhancements',
  description:
    'Explore the latest updates to Midjourney Prompt Manager for January 2025, featuring new sidebar quick navigation, themes, emotions, lighting, colors, and more!',
}
