...
```json
{
  "base_prompt": "A peaceful hobbit village nestled in rolling countryside hills, round wooden doors built into grassy mounds, winding cobblestone paths, gardens with vegetables and flowers, distant mountains, soft misty atmosphere",
