...
import textParameterGaps from './text-parameter-gaps.png'
import platformComparison from './platform-comparison.png'
import aiPromptGeneration from './ai-prompt-generation.png'
import versionControlWorkflow from './version-control-workflow.png'
import toolEcosystem from './tool-ecosystem.png'
import parityPrinciple from './parity-principle.png'
import communityCollaboration from './community-collaboration.png'
...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/article-thumbnails/nov-2025.png',
        width: 1200,
        height: 675,
        alt: article.title,
      },
  ...
  twitter: {
    ...
    title: article.title,
    description: article.description,
    images: ['/article-thumbnails/nov-2025.png'],
  },
}
...
<Image src={textParameterGaps} alt="Comparison showing UI features without text parameter equivalents" />
...
<Image src={platformComparison} alt="Comparison of text parameter support across AI image platforms" />
...
<Image src={aiPromptGeneration} alt="JSON prompt generation workflow with Claude AI" />
...
<Image src={versionControlWorkflow} alt="Git-based prompt version control system" />
...
<Image src={toolEcosystem} alt="Third-party tools that extend Midjourney via text parameters" />
...
<Image src={communityCollaboration} alt="Midjourney community collaborating through text-based prompts" />
