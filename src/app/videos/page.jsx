...
export default function Videos() {
  return (
    <SimpleLayout
      ...
      intro={
        <>
          <p>I'm a Kling AI Elite Creator and the founder of Key Prompt Ninja — an AI-powered prompt creation agent researched & trained over 2.5 years using 1,500 styles</p>
